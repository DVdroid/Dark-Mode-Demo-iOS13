...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let parentViewController = ParentViewController(with: searchViewController)
        parentViewController.tabBarItem = UITabBarItem(tabBarSystemItem: .search, tag: 1)
        ...
        tabBarController.viewControllers = [homeViewController, parentViewController, moreViewController]
